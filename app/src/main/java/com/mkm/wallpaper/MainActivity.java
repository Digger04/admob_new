...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppLovinSdk.getInstance("Q_AI_qdZnWGLGh5GCThuVLm3TooCaCtk0xdAQoscO3wUXoRJgTt30g5vdo4AgtCTJ9cTEDzGHAbkZi8aIPxZRo", appLovinSdkSettings, getApplicationContext()).initializeSdk();
